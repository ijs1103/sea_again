			...
			<div className="fixed -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl top-1/2 left-1/2">
				<div className="w-full px-4 py-2 rounded-lg">
					<div className='flex flex-col items-center gap-3'>
						{beach_img ? <Image src={beach_img} width={500} height={130} alt={beach_img} /> : <div className='bg-lightGray w-[500px] h-[130px] rounded-lg'></div>}
						<div className='flex items-center justify-between w-full'>
							<RWebShare data={{ text: `${sido_nm} ${gugun_nm}에 위치 하고 있습니다`, url: link_addr, title: `${sta_nm} 해수욕장` }} onClick={() => console.log('공유 하기 버튼 클릭')}>
								<svg className='w-8 h-8 cursor-pointer fill-modalPrimary' viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div className='text-center'>
								<h3 className='text-xl font-bold text-fontPrimary'>{sta_nm}</h3>
