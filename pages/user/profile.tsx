				...
				<form onSubmit={handleSubmit(onValid)} className='min-w-[500px] flex flex-col gap-3'>
					...
					<div>
						...
						<div className="relative">
							...
							<input type="text" id="email" className="brightness-75 opacity-75 outline-none bg-gray-50 text-gray-900 text-sm rounded-lg  focus:border-primary border-2 block w-full pl-10 p-2.5 border-gray-300" placeholder="abcde@naver.com" disabled />
						</div>
					</div>
